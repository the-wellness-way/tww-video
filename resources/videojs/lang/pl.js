videojs.addLanguage("pl",{
  ...
  "Embed": "Embed",
  "Social": "Socjale",
  "Copy video URL": "Kopiuj wideo URL",
  ...
  "Drag zoomed area using your mouse or a finger.": "Przesuń powiększony obszar przypomocy myszki.",
  "Forward": "Do przodu",
  "Rewind":  "Wstecz",
  "Mirror view": "Lustrzane odbicie",
  "Theater mode": "Tryb kina",
  "Exit Theater mode": "Opuść tryb kina",
  "Advertisement": "Reklama",
  "Skip Ad in": "Pomiń reklamę w",
  "Skip Now!": "Pomiń!",
  "Watch full video on": "Oglądaj video na" ,
  "Open Chromecast menu": "Menu Chromecast",
  "Disconnect Chromecast": "Rozłącz Chromecast",
  "Casting to": "Przesyłaj",
  "Skip Ad in %%TIME%%": "Pomiń reklamę w %%TIME%%",
  "Skip Ad": "Pomiń",
  "Ad %%NUM%% of %%TOTAL%%": "Reklama %%NUM%% z %%TOTAL%%",
  "Snapshot": "Zdjęcie",
